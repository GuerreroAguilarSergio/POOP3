...
elementos; cómo usar calendar*/            
    ...
    System.out.println(Math.max(80, 7));
        ...
        fecha1.set(2005, Calendar.MARCH, 26);
        agenda.put("Leonardo", fecha1);

        Calendar fecha2 = Calendar.getInstance();
        fecha2.set(2005, Calendar.APRIL, 30);
        agenda.put("Lorena", fecha2);

        Calendar fecha3 = Calendar.getInstance();
        fecha3.set(1977, Calendar.APRIL, 23);
        agenda.put("Reyna", fecha3);

        Calendar fecha4 = Calendar.getInstance();
        fecha4.set(2010, Calendar.OCTOBER, 27);
        agenda.put("Omar", fecha4);

        Calendar fecha5 = Calendar.getInstance();
        fecha5.set(1988, Calendar.SEPTEMBER, 7);
        agenda.put("Sergio", fecha5);
